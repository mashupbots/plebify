...
class PlebifyConfigSpec extends WordSpec with ShouldMatchers with GivenWhenThen with BeforeAndAfterAll {
  ...
  "PlebifyConfig" should {
    ...
    "load jobs and connectors" in {
      ...
      httpConnector.initializationTimeout should equal(30)
      ...
      job1Event2.initializationTimeout should equal(30)
      ...
      job1Task2.executionTimeout should be(30)
      ...
      job2.initializationTimeout should equal(30)
